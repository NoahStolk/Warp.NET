...
internal static class ContentFileReader
{
	...
	private static Map GetMap(BinaryReader br)
	{
		...
		return new(mapBinary.Entities
			.ConvertAll(e => new Entity(e.Properties, e.Brushes
				.ConvertAll(b => new Brush(b.Faces
					.ConvertAll(f => new Face(f.P1, f.P2, f.P3, f.TextureName, f.TextureAxisU, f.TextureAxisV, f.TextureScale)))))));
	}
