...
public class Slider : AbstractSlider
{
	...
	public override void Render(Vector2i<int> parentPosition)
	{
		...
		RenderImplUiBase.Game.MonoSpaceFontRenderer.Schedule(Vector2i<int>.One, parentPosition + centerPosition, Depth + 3, _textColor, CurrentValue.ToString("0.00"), TextAlign.Middle);
	}
}
